...
public class ArraysMain {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(arraysMain.sameTempValues(day, anotherDay) ? "Azonos értékek" : "Eltérő értékek");
        System.out.println("\nÓraátállítást figyelembe véve:");
        System.out.println(arraysMain.sameTempValuesDaylight(day, anotherDay) ? "Azonos értékek" : "Eltérő értékek");
        ...
        System.out.println(arraysMain.wonLottery(myNumbers, winNumbers) ? "Nyert" : "Nem nyert");
    ...
    public boolean wonLottery(int[] myNumbers, int[] winNumbers) {
